...
{{--                                    @dd($gallery->language())--}}
                                ...
                                <div class="input-field ">
                                    {!! Form::textarea('content['.$key.']',$gallery->language($language->id) !== null ? $gallery->language($language->id)->content : "",['class' => 'ckeditor validate materialize-textarea '.($errors->has('content.*') ? '' : 'valid')]) !!}
                                ...
                                <div class="input-field ">
                                    {!! Form::textarea('content_2['.$key.']',$gallery->language($language->id) !== null ? $gallery->language($language->id)->content_2 : "",['class' => 'ckeditor validate materialize-textarea '.($errors->has('content_2.*') ? '' : 'valid')]) !!}
                                ...
                                <div class="input-field ">
                                    {!! Form::textarea('content_3['.$key.']',$gallery->language($language->id) !== null ? $gallery->language($language->id)->content_3 : "",['class' => 'ckeditor validate materialize-textarea '.($errors->has('content_3.*') ? '' : 'valid')]) !!}
