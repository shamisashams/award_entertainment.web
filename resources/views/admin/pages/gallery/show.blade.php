...
{{-- page title --}}
@section('title', count($gallery->availableLanguage) >0 ? $gallery->availableLanguage[0]->value : "")
        ...
        <div class="card-content">
                ...
                <div class="col s12 m4">
                    <table class="striped">
                        ...
                        <tr>
                            ...
                            <td>{{\Carbon\Carbon::parse($gallery->created_at)}}</td>
                        </tr>
                        <tr>
                            <td>@lang('admin.updated_at')</td>
                            <td>{{\Carbon\Carbon::parse($gallery->updated_at)}}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="row mt-2">
                    ...
                    <ul class="tabs">
                        @foreach($gallery->languages as $key => $language)
                            @if(isset($languages[$language->language_id]))
                                <li class="tab">
                                    <a href="#cat-{{$gallery->id}}-{{$language->language_id}}">
                ...
                <div class="col sm12 mt-2">
                    @foreach($gallery->languages as $key => $language)
                        @if(isset($languages[$language->language_id]))
                            <div id="cat-{{$gallery->id}}-{{$language->language_id}}"
                                 class="">
                                <table class="striped">
                                    <tbody>
                                    <tr>
